 ...
 * @Modified:
 */
class ClientChannelInitializer(private val channelOperator: ChannelOperator): ChannelInitializer<SocketChannel>() {
 ...
 * @Modified:
 */
class ServerChannelInitializer(private val clientChannelTimeout: Int = 40, private val channelOperator: ChannelOperator): ChannelInitializer<SocketChannel>() {
